...
#define SCROLL_VIEW_PAGE_COUNT 3
...
- (IBAction)liveChatButtonPressed:(UIButton*)sender {
    NKLiveChatChoiceViewController *liveChatChoiceVC = [[NKLiveChatChoiceViewController alloc] initWithNibName:@"NKLiveChatChoiceViewController" bundle:nil];
    [self.navigationController pushViewController:liveChatChoiceVC animated:YES];
}

- (IBAction)treatmentLocatorButtonPressed:(UIButton*)sender {
    NKTreatmentChoiceViewController *treatmentChoiceVC = [[NKTreatmentChoiceViewController alloc] initWithNibName:@"NKTreatmentChoiceViewController" bundle:nil];
    [self.navigationController pushViewController:treatmentChoiceVC animated:YES];
}

- (IBAction)emergencyContactsButtonPressed:(UIButton*)sender {
    NKEmergencyContactsViewController *emergencyContactsVC = [[NKEmergencyContactsViewController alloc] initWithNibName:@"NKEmergencyContactsViewController" bundle:nil];
    [self.navigationController pushViewController:emergencyContactsVC animated:YES];
}

- (IBAction)safetyPlansButtonPressed:(UIButton*)sender {
    NKSafetyPlansViewController *safetyPlansVC = [[NKSafetyPlansViewController alloc] initWithNibName:@"NKSafetyPlansViewController" bundle:nil];
    [self.navigationController pushViewController:safetyPlansVC animated:YES];
}
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (savedOpenComps) {
        ...
        if (![[NSUserDefaults standardUserDefaults] boolForKey:kHasShownIntroScreenKey]) {
            ...
            //Namkour - do not force the user to go to accounts page
